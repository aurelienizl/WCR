...
namespace WCRC_Console.Reporting
{
    internal static class PrintData
    {
        public static void PrintTpm(List<Win32_Tpms> win32_tpmList)
        {
        ...
        public static void PrintProducts(List<Win32_Products> win32_Products)
        {
        ...
        public static void PrintEncryptableVolume(List<Win32_EncryptableVolumes> win32_EncryptableVolumeList)
        {
        ...
        public static void printQFE(List<Win32_QuickFixEngineerings> win32_QuickFixEngineerings)
        {
