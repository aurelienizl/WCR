...
namespace Win32ClassModule
{
    internal class Report
    {
        ...
        public Report(List<Win32_Bios>? win32_Bios, List<Win32_EncryptableVolume>? win32_EncryptableVolumes, List<Win32_Tpm>? win32_Tpms,
        ...
        {
            WriteToJsonFile<Report>("report.json", report);
        }
